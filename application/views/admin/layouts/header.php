...
<head>
    ...
    <link href="<?= base_url('assets/admin/lib/owlcarousel/assets/owl.carousel.min.css') ?>" rel="stylesheet">
    <link href="<?= base_url('assets/admin/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css') ?>" rel="stylesheet" />
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?= base_url('dashboard_admin') ?>" class="nav-item nav-link  <?php if ($this->uri->segment(1) == 'dashboard_admin') echo 'active'; ?>"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    ...
                    <!-- <a href="<?= base_url('saldo_admin') ?>" class="nav-item nav-link <?php if ($this->uri->segment(1) == 'saldo_admin') echo 'active'; ?>"><i class="fas fa-receipt me-2"></i>Saldo User</a> -->
                    <div class="pt-5"></div>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="<?= base_url('assets/admin/img/user.png') ?>" alt="" style="width: 40px; height: 40px;">
                            <span class="d-none d-lg-inline-flex"><?php echo $this->session->userdata('username')?></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="<?= base_url('profile_admin') ?>" class="dropdown-item">Profile</a>
                            <a href="<?= base_url('auth/change_password') ?>" class="dropdown-item">Ubah Password</a>
